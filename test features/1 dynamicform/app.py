...
def entrydata():
    ...
    if image_file:
        image_file.save('static/' + image_file.filename)

    data = {'studentname': studentname, 'institute': institute, 'designation': designation, 'course': course, 'image_file': image_file}
